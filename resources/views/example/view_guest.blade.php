...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Area Public</h1>
                <a href="{{ url('pertanyaan/create') }}" class="btn btn-primary mb-2">BUAT PERTANYAAN</a>
            </div>
            <div class="col-sm-6">
                            ...
                            <div class="post">
                                <div class="question-summary narrow d-inline-flex">
                                    ...
                                    <div class="summary">
                                        ...
                                        <h4><a href="pertanyaan/detail/{{ $val->id }}" class="question-hyperlink">{{ $val->judul}}</a></h4>
                                        <p>{!! $val->isi !!}</p>
                                        <div class="tags">
...
>>>>>>> 6e74f6e75bae8f9202151fe5aa17e102b5c03d0d
                                        ...
                                        <div class="started">
                                            Asked : {{ $val->created_at }} ; by : {{ $val2['nama_lengkap'] }}
                                        </div>
                                        @endif
                                        @endforeach
                                    </div>
